...
import { MoveTypes } from '../interfaces/MoveTypes';

@Component({
  selector: 'app-img-croppr-v2',
  templateUrl: './img-croppr-v2.component.html',
  styleUrls: ['./img-croppr-v2.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ImgCropprV2Component implements OnChanges, OnInit{
  ...
  private Hammer: HammerStatic = typeof window !== 'undefined'
    ...
    @ViewChild('wrapper', {read: true}) wrapper: ElementRef;
    @ViewChild('sourceImage', {read: false}) sourceImage: ElementRef;
