...
export class Properties {
	...
	oneClickLaunchRedistributeAccessRemovedErrorMessage = "Edit campaign is no longer available because the vendor deleted the shared list/no list associated with this campaign";
