...
import { ChangeAgencyContentStatusComponent } from 'app/util/change-agency-content-status/change-agency-content-status.component';
...
@NgModule({
	...
	declarations: [DonutChartComponent, PaginationComponent, WorldmapComponent, PieChartComponent,
		...
		CommentsComponent,ChangeAgencyContentStatusComponent],
