...
@Component({
    ...
    templateUrl: './campaign-sms-video.component.html',
    styleUrls: ['./campaign-sms-video.component.css','../../../assets/css/loader.css'],
    providers: [XtremandLog,Processor]
})
export class CampaignSMSVideoComponent implements OnInit, OnDestroy {
    ...
    getCampaignVideo() {
        ...
        this.utilService.getJSONLocation()
            ...
            (data: any) => {
                ...
                console.log(this.smsLog);
                this.videoFileService.showSmsCampaignVideo(this.smsLog)
                    .subscribe(
                    (result: any) => {
    ...
    videoLogAction(xtremandLog: XtremandLog) {
      ...
      xtremandLog.alias = this.alias;
        ...
        this.videoFileService.logCampaignVideoActionsSms(xtremandLog).subscribe(
            (result: any) => {
    ...
    logVideoViewsCount() {
        this.videoFileService.logVideoViewsSms(this.campaignVideoFile.alias,this.alias).subscribe(
            (result: any) => {
