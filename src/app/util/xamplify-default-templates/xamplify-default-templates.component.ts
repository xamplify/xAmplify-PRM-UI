   ...
   let self = this;
        ...
        const validationChecks = [
          {
            ...
            checks: [
              ...
              { condition: () => (emailTemplateType === "JOIN_VENDOR_COMPANY" || "JOIN_MY_TEAM"==emailTemplateType || "WELCOME_EMAIL_REMAINDER" === emailTemplateType) && !jsonContent.includes("{{senderFullName}}"), message: "Whoops! We are unable to save this template because you deleted '{{senderFullName}}' tag." },
              ...
              { condition: () => ["JOIN_PRM_COMPANY", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes("{{senderFullName}}"), message: "Whoops! We are unable to save this template because you deleted '{{senderFullName}}' tag." },
              ...
              { condition: () => ["TRACK_PUBLISH", "PLAYBOOK_PUBLISH", "ASSET_PUBLISH", "SHARE_LEAD", "ONE_CLICK_LAUNCH", "PAGE_CAMPAIGN_PARTNER", "PAGE_CAMPAIGN_CONTACT", "SOCIAL_CAMPAIGN", "TO_SOCIAL_CAMPAIGN", "PARTNER_SIGNATURE_ENABLED", , "PARTNER_SIGNATURE_PENDING", "LEAD_DETAILS_UPDATE", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{senderCompanyName}}'), message: "Whoops! We are unable to save this template because you deleted '{{senderCompanyName}}' tag." },
              ...
              { condition: () => jsonContent.indexOf("login_url") < 0 && (emailTemplateType === "COMPANY_PROFILE_INCOMPLETE" ||  emailTemplateType === "TEAM_MEMBER_PORTAL" || emailTemplateType === "WELCOME_EMAIL_REMAINDER"), message: "Whoops! We are unable to save this template because you deleted 'login_url' tag." },
              ...
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "PRM_LEAD_APPROVE", "PRM_LEAD_REJECT", "LEAD_DETAILS_UPDATE", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{leadName}}'), message: "Whoops! We are unable to save this template because you deleted '{{leadName}}' tag." },
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{leadAssociatedCampaign}}'), message: "Whoops! We are unable to save this template because you deleted '{{leadAssociatedCampaign}}' tag." },
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "PRM_LEAD_APPROVE", "PRM_LEAD_REJECT", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{leadComment}}'), message: "Whoops! We are unable to save this template because you deleted '{{leadComment}}' tag." },
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "PRM_LEAD_APPROVE", "PRM_LEAD_REJECT","WELCOME_EMAIL_REMAINDER"].includes(emailTemplateType) && !jsonContent.includes('{{VENDOR_COMPANY_NAME}}'), message: "Whoops! We are unable to save this template because you deleted '{{VENDOR_COMPANY_NAME}}' tag." },
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "PRM_LEAD_APPROVE", "PRM_LEAD_REJECT", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{leadStage}}'), message: "Whoops! We are unable to save this template because you deleted '{{leadStage}}' tag." },
              ...
              { condition: () => ["LEAD_APPROVE", "LEAD_REJECT", "PRM_LEAD_APPROVE", "PRM_LEAD_REJECT", "LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes('{{leadCompany}}'), message: "Whoops! We are unable to save this template because you deleted '{{leadCompany}}' tag." },
              { condition: () => emailTemplateType === "LEAD_DETAILS_UPDATE" && !jsonContent.includes("{{leadFieldsDetails}}"), message: "Whoops! We are unable to save this template because you deleted '{{leadFieldsDetails}}' tag."},
              { condition: () => ["LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes("{{teammemberFullName}}"), message: "Whoops! We are unable to save this template because you deleted '{{teammemberFullName}}' tag."},
              { condition: () => ["LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes("{{partnerModuleCustomName}}"), message: "Whoops! We are unable to save this template because you deleted '{{partnerModuleCustomName}}' tag."},
              { condition: () => ["LEAD_STATUS_REMINDER_NOTIFICATION", "PRM_LEAD_STATUS_REMINDER_NOTIFICATION"].includes(emailTemplateType) && !jsonContent.includes("{{partnerCompany}}"), message: "Whoops! We are unable to save this template because you deleted '{{partnerCompany}}' tag."},
            ]
          },
        ];
    ...
    let emailTemplateType = emailTemplate.typeInString
      ...
      if (["TEAM_MEMBER_PORTAL"].includes(emailTemplateType)) {
        ...
        if ("LEAD_DETAILS_UPDATE" == emailTemplateType) {
          mergeTags = [{ name: 'Customer Full Name', value: '{{customerFullName}}' },
            { name: 'Lead Name', value: '{{leadName}}' },
            { name: 'Lead Fields Details', value: '{{leadFieldsDetails}}' },
            { name: 'Sender Company Name', value: '{{senderCompanyName}}' },
          ];
        }

      if ("LEAD_STATUS_REMINDER_NOTIFICATION" === emailTemplateType || "PRM_LEAD_STATUS_REMINDER_NOTIFICATION" === emailTemplateType) {
        mergeTags = [{ name: 'Team Member Full Name', value: '{{teammemberFullName}}' },
        { name: 'Partner Module Custom Name', value: '{{partnerModuleCustomName}}' },
        { name: 'Partner Name', value: '{{partnerName}}' },
        { name: 'Partner Company', value: '{{partnerCompany}}' },
        { name: 'Lead Name', value: '{{leadName}}' },
        ...
        if (emailTemplateType === "LEAD_STATUS_REMINDER_NOTIFICATION") {
          mergeTags.push({name: 'Lead Associated Campaign', value: '{{leadAssociatedCampaign}}'});
        }
      }
      
      if ("WELCOME_EMAIL_REMAINDER" == emailTemplateType) {
        mergeTags = [{ name: 'Sender First Name', value: '{{firstName}}' },
        { name: 'Sender Last Name', value: '{{lastName}}' },
        { name: 'Sender Full Name', value: '{{senderFullName}}' },
        { name: 'Sender Email Id', value: '{{emailId}}' },
