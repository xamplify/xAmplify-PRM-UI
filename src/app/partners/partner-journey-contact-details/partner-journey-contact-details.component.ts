...
@Component({
  selector: 'app-partner-journey-contact-details',
  templateUrl: './partner-journey-contact-details.component.html',
  styleUrls: ['./partner-journey-contact-details.component.css'],
  providers: [SortOption]
})
export class PartnerJourneyContactDetailsComponent implements OnInit {
  ...
  getContactDetails(pagination: Pagination) {
    ...
    this.parterService.getContactDetails(this.pagination).subscribe(
      (response: any) => {
