...
@Component({
  selector: 'app-individual-partner-analytics',
  templateUrl: './individual-partner-analytics.component.html',
  styleUrls: ['./individual-partner-analytics.component.css'],
  providers: [Pagination, HomeComponent, HttpRequestLoader, SortOption, ListLoaderValue]
})
export class IndividualPartnerAnalyticsComponent implements OnInit, OnDestroy {
  landingPage: any;
