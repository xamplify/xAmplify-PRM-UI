...
emailRegEx:any = /^[A-Za-z0-9]+(\.[_A-Za-z0-9]+)*@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*(\.[A-Za-z]{2,})$/;
    ...
    constructor( public socialPagerService: SocialPagerService, private authenticationService: AuthenticationService, private partnerService: PartnerService,
    ...
    saveValidEmails() {
        ...
        this.partnerService.saveContactList( this.model.contactListName, this.newUsers )
            .subscribe(
            data => {
                data = data;
                ...
                this.partnerService.successMessage = true;
            },
            ( error: any ) => {
    ...
    saveClipboardValidEmails() {
        ...
        if ( this.model.contactListName != ' ' ) {
            ...
            this.partnerService.saveContactList( this.model.contactListName, this.clipboardUsers )
                .subscribe(
                data => {
                    data = data;
                    this.xtremandLogger.info( "update Contacts ListUsers:" + data );
        ...
        if ( this.model.contactListName != '' && !this.isValidContactName && this.model.contactListName != ' ' ) {
            if ( this.contacts.length > 0 ) {
                ...
                if ( this.validCsvContacts == true ) {
                    ...
                    this.partnerService.saveContactList( this.model.contactListName, this.contacts )
                        .subscribe(
                        data => {
                            data = data;
                            this.xtremandLogger.info( "update Contacts ListUsers:" + data );
    ...
    getGoogleContactsUsers() {
        this.partnerService.googleCallBack = false;
        this.socialContact.socialNetwork = "GOOGLE";
        var self = this;
        this.partnerService.getGoogleContacts( this.socialContact )
            .subscribe(
            data => {
    ...
    saveGoogleContacts() {
        ...
        if ( this.model.contactListName != '' && !this.isValidContactName && this.model.contactListName != ' ' ) {
            if ( this.gContacts.length > 0 ) {
                this.partnerService.saveSocialContactList( this.socialContact )
                    .subscribe(
                    data => {
                        data = data;
                        this.xtremandLogger.info( "update Contacts ListUsers:" + data );
    ...
    saveGoogleContactSelectedUsers() {
        ...
        if ( this.model.contactListName != '' && !this.isValidContactName && this.model.contactListName != ' ' && selectedUsers.length != 0 ) {
            ...
            this.partnerService.saveContactList( this.model.contactListName, selectedUsers )
                .subscribe(
                data => {
                    data = data;
                    this.xtremandLogger.info( "update Contacts ListUsers:" + data );
    ...
    getZohoContacts( contactType: any, username: string, password: string ) {
        this.socialContact.socialNetwork = "";
        var self = this;
        this.partnerService.getZohoContacts( this.userName, this.password, this.contactType )
            .subscribe(
            data => {
    ...
    authorisedZohoContacts() {
        ...
        this.partnerService.getZohoAutherizedContacts( this.socialContact )
            .subscribe(
            data => {
                this.getZohoConatacts = data;
    ...
    onChangeSalesforceDropdown( event: Event ) {
        ...
        if ( this.contactType == "contact_listviews" || this.contactType == "lead_listviews" ) {
            $( "button#salesforce_save_button" ).prop( 'disabled', true );
            this.partnerService.getSalesforceContacts( this.socialNetwork, this.contactType )
                .subscribe(
                data => {
    ...
    getSalesforceListViewContacts( contactType: any ) {
        ...
        this.partnerService.getSalesforceListViewContacts( this.socialNetwork, this.contactType, this.salesforceListViewId, this.salesforceListViewName )
            .subscribe(
            data => {
                this.getSalesforceConatactList = data;
                this.selectedAddContactsOption = 3;
    ...
    socialContactImage() {
        this.partnerService.socialContactImages()
            .subscribe(
            data => {
                this.storeLogin = data;
    ...
    unlinkSocailAccount() {
        ...
        this.partnerService.unlinkSocailAccount( socialNetwork, this.isUnLinkSocialNetwork )
            .subscribe(
            ( data: any ) => {
    ...
    ngOnInit() {
       // this.validateAddContactForm();
        ...
        if ( this.partnerService.googleCallBack == true ) {
            this.getGoogleContactsUsers();
        } else if ( this.partnerService.salesforceContactCallBack == true ) {
            $( "#salesforceModal" ).modal();
            this.partnerService.salesforceContactCallBack = false;
        }
