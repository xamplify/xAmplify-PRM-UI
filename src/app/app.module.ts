...
import { TeamMemberWiseAssetDetailsComponent } from './util/team-member-wise-asset-details/team-member-wise-asset-details.component';
...
@NgModule({
    declarations: [AppComponent, SocialLoginComponent, SocialCallbackComponent, ShareVideoComponent,
        ...
        VanityAddContactsComponent, VanitySynchronizeContactsComponent, VanitySocialContactsCallbackComponent, ConfirmationComponent, TeamMemberWiseAssetDetailsComponent,
    ],
