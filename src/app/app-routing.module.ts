...
export const routes: Routes = [
    ...
    { path: 'showCampaignVideo/:alias/:isTestEmail', component: CampaignVideoComponent },
    { path: 'showCampaignEmail/:alias/:isTestEmail', component: LogRegularCampaignComponent },
    { path: 'company-page/:alias', component: CompanyPageComponent },
    { path: 'partner-page/:alias', component: CompanyPageComponent },
    { path: 'loge/:alias/:isTestEmail', component: LogEmailClickComponent },
