...
export class ReferenceService {
	...
	getCountries() {
		return [
			...
			new Country(80, 'TF', 'French Southern Territories (Terres australes francaises)'),
			...
			new Country(209, 'PM', 'St. Pierre & Miquelon (Saint-Pierre-et-Miquelon)'),
	...
	getTimeZones() {
		return [
			...
			new Timezone(9, 'Antarctica/DumontDUrville', '(GMT+10:00) Dumont D Urville'),
			...
			new Timezone(11, 'America/Argentina/Buenos_Aires', '(GMT-03:00) Buenos Aires'),
			...
			new Timezone(14, 'Australia/Adelaide', '(GMT+10:30) Central Time - Adelaide'),
			new Timezone(14, 'Australia/Darwin', '(GMT+09:30) Central Time - Darwin'),
			new Timezone(14, 'Australia/Brisbane', '(GMT+10:00) Eastern Time - Brisbane'),
			new Timezone(14, 'Australia/Hobart', '(GMT+11:00) Eastern Time - Hobart'),
			new Timezone(14, 'Australia/Sydney', '(GMT+11:00) Eastern Time - Melbourne, Sydney'),
			...
			new Timezone(28, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(40, 'America/Vancouver', '(GMT-08:00) Pacific Time - Vancouver'),
			new Timezone(40, 'America/Whitehorse', '(GMT-08:00) Pacific Time - Whitehorse'),
			new Timezone(40, 'America/Dawson_Creek', '(GMT-07:00) Mountain Time - Dawson Creek'),
			new Timezone(40, 'America/Edmonton', '(GMT-07:00) Mountain Time - Edmonton'),
			new Timezone(40, 'America/Yellowknife', '(GMT-07:00) Mountain Time - Yellowknife'),
			new Timezone(40, 'America/Regina', '(GMT-06:00) Central Time - Regina'),
			new Timezone(40, 'America/Winnipeg', '(GMT-06:00) Central Time - Winnipeg'),
			...
			new Timezone(40, 'America/Halifax', '(GMT-04:00) Atlantic Time - Halifax'),
			new Timezone(40, 'America/St_Johns', '(GMT-03:30) Newfoundland Time - St. Johns'),
			...
			new Timezone(57, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(61, 'Europe/Prague', '(GMT+01:00) Central European Time - Prague'),
			...
			new Timezone(99, 'America/Tegucigalpa', '(GMT-06:00) Central Time - Tegucigalpa'),
			...
			new Timezone(130, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(142, 'America/Tijuana', '(GMT-08:00) Pacific Time - Tijuana'),
			new Timezone(142, 'America/Hermosillo', '(GMT-07:00) Mountain Time - Hermosillo'),
			new Timezone(142, 'America/Mazatlan', '(GMT-07:00) Mountain Time - Chihuahua, Mazatlan'),
			new Timezone(142, 'America/Mexico_City', '(GMT-06:00) Central Time - Mexico City'),
			...
			new Timezone(147, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(183, 'Europe/Kaliningrad', '(GMT+02:00) Moscow-01 - Kaliningrad'),
			new Timezone(183, 'Europe/Moscow', '(GMT+03:00) Moscow+00 - Moscow'),
			new Timezone(183, 'Europe/Samara', '(GMT+04:00) Moscow+01 - Samara'),
			new Timezone(183, 'Asia/Yekaterinburg', '(GMT+05:00) Moscow+02 - Yekaterinburg'),
			new Timezone(183, 'Asia/Omsk', '(GMT+06:00) Moscow+03 - Omsk'),
			new Timezone(183, 'Asia/Krasnoyarsk', '(GMT+07:00) Moscow+04 - Krasnoyarsk'),
			new Timezone(183, 'Asia/Irkutsk', '(GMT+08:00) Moscow+05 - Irkutsk'),
			new Timezone(183, 'Asia/Yakutsk', '(GMT+09:00) Moscow+06 - Yakutsk'),
			new Timezone(183, 'Asia/Vladivostok', '(GMT+10:00) Moscow+07 - Vladivostok'),
			new Timezone(183, 'Asia/Magadan', '(GMT+11:00) Moscow+08 - Magadan'),
			new Timezone(183, 'Asia/Kamchatka', '(GMT+12:00) Moscow+09 - Petropavlovsk-Kamchatskiy'),
			...
			new Timezone(190, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(195, 'Europe/Prague', '(GMT+01:00) Central European Time - Prague'),
			new Timezone(196, 'Europe/Belgrade', '(GMT+01:00) Central European Time - Belgrade'),
			...
			new Timezone(238, 'America/Phoenix', '(GMT-07:00) Mountain Time - Arizona'),
	...
	replaceMyMergeTags(myMergeTags: any, updatedBody: string) {
		if (myMergeTags != undefined && this.hasMyMergeTagsExits(updatedBody)) {
			...
			updatedBody = updatedBody.replace(this.senderMergeTag.senderOccupation, myMergeTags.myOccupation);
	...
	changeSideBar() {
		...
		if (!this.isSidebarClosed) {
			...
			document.body.className = 'login page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed';
		}
	}
	...
	hasMyMergeTagsExits(body: string) {
		...
		body.indexOf(this.senderMergeTag.senderOccupation) > -1  || body.indexOf(this.senderMergeTag.senderEmailId) > -1 || body.indexOf(this.senderMergeTag.senderContactNumber) > -1 || body.indexOf(this.senderMergeTag.senderCompany) > -1
