...
export const routes: Routes = [
  ...
  { path: "manage/:viewType", component: ManageLmsComponent },
	{ path: "manage/:viewType/:categoryId/:folderViewType", component: ManageLmsComponent },
  { path: "shared", component: ManageLmsComponent },
  { path: "shared/:viewType", component: ManageLmsComponent },
	{ path: "shared/:viewType/:categoryId/:folderViewType", component: ManageLmsComponent },
