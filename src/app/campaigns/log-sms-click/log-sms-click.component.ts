...
@Component({
  selector: "app-log-sms-click",
  templateUrl: "./log-sms-click.component.html",
  styleUrls: [
    "./log-sms-click.component.css",
    "../../../assets/css/loader.css"
  ]
})
export class LogSMSClickComponent implements OnInit {
