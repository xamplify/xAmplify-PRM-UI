...
export class CampaignService {
    ...
    getEventCampaignEmailOpenDetails(campaignId: number, isChannelCampaign: boolean) {
    ...
    getEventCampaignRedistributionEmailOpenDetails(campaignId: number, userId: any) {
