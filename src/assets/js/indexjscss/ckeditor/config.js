...
CKEDITOR.editorConfig = function( config ) {
	...
	config.strinsert_strings = [
								...
								{ 'name': 'Sender Company Google Url', 'value': '{{senderCompanyGoogleUrl}}' },
								{ 'name': 'Sender Company Facebook Url', 'value': '{{senderCompanyFacebookUrl}}' },
								{ 'name': 'Sender Company Linkedin Url', 'value': '{{senderCompanyLinkedinUrl}}' },
